# -*- coding: utf-8 -*-
"""
Created on Sun Feb  5 22:23:09 2023
...
def TELECOM_CHURN():
    ...
    #loading the model
    loaded_model = pickle.load(open('D:/Arya User/DS_Projects/Project -1 Customer Churn Prediction/telecom_churn.sav','rb'))
    ...
    night_charge     = st.sidebar.number_input('Night Charge', min_value=0)
    eve_charge     = st.sidebar.number_input('Evening Charge', min_value=0)
    ...
    if st.button('Predict Churn Status'):
        churn_status= churn_prediction([voice_plan,voice_messages,eve_mins,night_mins,intl_mins,day_mins,customer_calls,intl_plan
                                        ,intl_calls,intl_charge,day_charge,eve_charge,night_charge])
